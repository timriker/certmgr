...
- F5 deployment uses the Big-IP iControl REST API; some environments require a
  different upload workflow (file-transfer upload then import). The current
  implementation tries the simple create/PUT flow and should be adapted for
  specific F5 versions.
